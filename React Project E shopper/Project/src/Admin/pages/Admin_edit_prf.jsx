                                                    ...
                                                    <div className="row gutters">
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" value={formvalue.phone} name='phone' className="form-control" id="phone" placeholder="Enter phone number" />
                                                            </div>
                                                        </div>
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                    ...
                                                    <div className="row gutters">
                                                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                            <div className="text-right">
                                                                <button type="submit" class="btn btn-secondary me-2" onClick={() => redirect('/Admin_profile')}>Cancel</button>

...
function View_product() {
    ...
    const submiHandel = async (e) => {
        e.preventDefault();
        const res = await axios.post(`http://localhost:3000/Addtocart`, getdata);
        console.log(res);
        if (res.status == 201) {
            toast.success("Data added successfully");
            setdata({ ...getdata, size: "", color: "", count: 1 })
        }
    }
    ...
    const handleSizeChange = (e) => {
        setdata({ ...getdata, size: e.target.value });
    }

    const handleColorChange = (e) => {
        setdata({ ...getdata, color: e.target.value });
    }
    ...
    const addProducts = async (data) => {
        ...
        if (user_id) {
            ...
            const result = await axios.post(`http://localhost:3000/Addtocart`, { ...data, ...getdata })
            ...
            <div class="container-fluid py-5" data-aos="fade-up">
                {
                    data && data.map((value, index) => {
                        return (
                            <div class="row px-xl-5" key={index} onSubmit={submiHandel}>
                                <div class="col-lg-5">
                                ...
                                <div class="col-lg-7 pb-5">
                                    ...
                                    <div class="d-flex align-items-center mb-4 pt-2">
                                        ...
                                        <Link to={'/add_to_cart/' + value.id}><button onClick={() => addProducts(value)} class="btn btn-dark px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button></Link>                                    </div>
